...
export default function HeroIntroSection({
  ...
  return (
    <>
      {/* Hero Section */}
      <section
        className="bg-cover bg-center relative z-[1]"
        style={{ backgroundImage: `url('${backgroundImage}')` }}
      >
        <div className={`text-white text-center px-5 ${heroHeight} flex flex-col justify-center items-center`}>
          <div
            className="text-4xl lg:text-5xl lg:mx-auto header-text"
            data-aos="fade-up"
